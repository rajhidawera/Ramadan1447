  ...
  return (
    <div className="min-h-screen bg-[#003366] flex flex-col items-center justify-center p-8 text-white text-center relative overflow-hidden font-['Tajawal']" dir="rtl">
      ...
      <div className="relative z-10 flex flex-col items-center animate-in" style={{ animationName: 'fade-in', animationDuration: '1s' }}>
        <div 
          className="bg-white p-4 rounded-3xl shadow-2xl mb-8 transform transition-transform hover:scale-105"
          style={{ animation: 'slide-in-from-top 0.8s ease-out' }}
        >
          <img src="https://next.rajhifoundation.org/files/52c533df-1.png" alt="شعار مؤسسة عبدالله الراجحي الخيرية" className="h-24 w-24" />
        </div>
        ...
        <button 
          onClick={onEnter} 
          className="bg-[#C5A059] text-[#003366] px-12 py-5 rounded-2xl font-black text-lg shadow-lg hover:bg-white transition-all transform hover:scale-105 active:scale-95 border-4 border-white/20"
